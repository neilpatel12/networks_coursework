...
def largest_deg_dist_p1(N_list,m):
    N = np.linspace(min(N_list), max(N_list), 100)
...
step = 5
no_trials = 10**3
set1 = np.load(f'Code/Data/ldd/Phase1_k1_dist/k1_dist_N_range_{N_lower}_{N_upper}_step_{step}_no_trials_{no_trials}.npy')

N_lower = 10**3
N_upper = 10**5
step = 5
no_trials = 10**2
set2 = np.load(f'Code/Data/ldd/Phase1_k1_dist/k1_dist_N_range_{N_lower}_{N_upper}_step_{step}_no_trials_{no_trials}.npy')

N_lower = 10**5
N_upper = 10**6
step = 3
no_trials = 10**1
set3 = np.load(f'Code/Data/ldd/Phase1_k1_dist/k1_dist_N_range_{N_lower}_{N_upper}_step_{step}_no_trials_{no_trials}.npy')
...
# N_list = np.concatenate((set1_mean[:,0], set2_mean[:,0], set3_mean[:,0]))
# k1_mean_list = np.concatenate((set1_mean[:,1], set2_mean[:,1], set3_mean[:,1]))
# error_list = np.concatenate((set1_std[:,1], set2_std[:,1], set3_std[:,1]))
...
k1_theory, N_theory = largest_deg_dist_p1(N_list,m)
